 ...
 * @author house
 */
public class TelaBuscaAla extends javax.swing.JDialog {

    /**
     * Creates new form ModeloBuscas
     */
    public TelaBuscaAla(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaAla dialog = new TelaBuscaAla(new javax.swing.JFrame(), true);

 ...
 * @author professor
 */
public class TelaCadastroAla extends javax.swing.JDialog {

    /**
     * Creates new form ModeloCadastral_2024
     */
    public TelaCadastroAla(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadComboBox();
    }
   ...
   private void loadComboBox() {
        statusComboBox.setModel(new DefaultComboBoxModel<>(new StatusCadastroEnum[] {
            StatusCadastroEnum.ATIVO,
            StatusCadastroEnum.INATIVO
        }));
    }
     ...
     */
    @SuppressWarnings("all") // Required for Netbeans GUI builder
    private void initComponents() {
        ...
        jPanelDados.add(descricaoField, new org.netbeans.lib.awtextra.AbsoluteConstraints(8, 84, 610, 30));
        ...
        jPanelDados.add(nomeField, new org.netbeans.lib.awtextra.AbsoluteConstraints(8, 120, 610, 30));

        getContentPane().add(jPanelDados, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 49, 760, 160));
        ...
        getContentPane().add(jPanelBotoes, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, 760, -1));
...
//        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroAla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaCadastroAla dialog = new TelaCadastroAla(new javax.swing.JFrame(), true);

 ...
 * @author aluno
 */
public class TelaBuscaFarmaceutico extends javax.swing.JDialog {

    /**
     * Creates new form ModeloBuscas
     */
    public TelaBuscaFarmaceutico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        JTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "CRF", "CPF", "Fone 1", "Fone 2", "Email", "Nome Social", "RG", "Data Cadastro", 
                "CEP", "Cidade", "Bairro", "Logradouro", "Complemento", "Login", "Senha", "Status"
            }
        ) {
            @Override
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaFarmaceutico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaFarmaceutico dialog = new TelaBuscaFarmaceutico(new javax.swing.JFrame(), true);

 ...
 * @author aluno
 */
public class TelaBuscaAcompanhante extends javax.swing.JDialog {

    /**
     * Creates new form ModeloBuscas
     */
    public TelaBuscaAcompanhante(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        JTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Grau de parentesco", "CPF", "Telefone", "Email", "Status"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaAcompanhante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaAcompanhante dialog = new TelaBuscaAcompanhante(new javax.swing.JFrame(), true);

...
public class TelaBuscaLeito extends javax.swing.JDialog {
     ...
     */
    public TelaBuscaLeito(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        filtroComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "DESCRICAO", "STATUS", "QUARTO" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaLeito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaLeito dialog = new TelaBuscaLeito(new javax.swing.JFrame(), true);

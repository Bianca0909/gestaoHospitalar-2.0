...
public class ControllerCadastroEnfermeiro implements ActionListener {
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (evento.getSource() == this.telaCadastroEnfermeiro.getjButtonNovo()) {
            ...
            enfermeiro.setStatus(this.telaCadastroEnfermeiro.getStatusComboBox().getSelectedItem().toString());
    ...
    private void abrirBusca() {
        ...
        int codigoRetorno = controllerBuscaEnfermeiro.getCodigoRetorno();
        if (codigoRetorno != 0) {
            Enfermeiro enfermeiro = service.ServiceEnfermeiro.ler(codigoRetorno);
            if (enfermeiro != null) {
                Utilities.ativaDesativa(true, this.telaCadastroEnfermeiro.getjPanelBotoes());
                Utilities.limpaComponentes(true, this.telaCadastroEnfermeiro.getjPanelDados());

                this.telaCadastroEnfermeiro.getIdField().setText(String.valueOf(enfermeiro.getId()));
                ...
                this.telaCadastroEnfermeiro.getIdField().setEnabled(false);
                this.telaCadastroEnfermeiro.getjButtonNovo().setEnabled(false);
                this.telaCadastroEnfermeiro.getjButtonCancelar().setEnabled(true);
                this.telaCadastroEnfermeiro.getjButtonGravar().setEnabled(true);
                this.telaCadastroEnfermeiro.getjButtonBuscar().setEnabled(false);
                this.telaCadastroEnfermeiro.getjButtonSair().setEnabled(false);
